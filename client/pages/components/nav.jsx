...
function navbar(props) {
    ...
    return (
        <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
            <nav className="mt-6 relative max-w-7xl w-full bg-white border border-gray-200 rounded-[10px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-blue-600 dark:white" aria-label="Global">
                <div className="flex items-center justify-between">
                    <a className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="School">Report Repair</a>
                ...
                <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                    <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
                        <a className="font-medium text-gray-500 hover:text-gray-400 md:py-6 dark:text-white dark:hover:text-blue-900" href="/" aria-current="page">Home</a>
                        <a className="font-medium text-gray-500 hover:text-gray-400 md:py-6 dark:text-white dark:hover:text-blue-900" href="/teacherPage">Report</a>
                        ...
                        {/* <a className="flex items-center gap-x-2 font-medium text-white hover:text-blue-600 md:border-l md:border-gray-300 md:my-6 md:pl-6 dark:border-gray-700 dark:text-white dark:hover:text-yellow-500" href="#">
                        ...
                        {props.auth ?
                            <button type="button"
                                className={"w-full lg:w-auto text-left text-white font-semibold hover:text-yellow-500 "}
                                onClick={handleLogout}
                            >
                                Sign out &rarr;
                            </button>
                            : <Signin classNames={"-mx-3 block rounded-lg px-3 py-2 text-base leading-7 text-white font-semibold hover:text-green-500"} />
                        }
                    </div>
                </div>
            </nav>
